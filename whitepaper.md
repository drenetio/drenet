...
## 系统构建
要实现去中心化资源交易网络，首先需要一个去中心化的资源存储与内容分发网络，目前已有IPFS在这个方向做出了探索并获得成功，资源请求发出后，内容分发网络将会路由请求到正确的数据源，数据源将提出交易请求并提交交易请求到交易系统，同时加密数据并传输，当资源请求方获得数据后，需要完成数据源提交给交易系统的交易请求，才能进行数据的解密。
## 资源存储及分发
